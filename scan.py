...
S1_VOL_RATIO = 1.20    # 20D/50D (soft)
S1_DEL_MIN   = 45.0    # 20D avg delivery (active 10+ days)
S1_DEL_GAP   = 3.0     # 20D > 50D + 3% (active 20+ days)
S1_TV_MIN    = 7.5     # Cr/day (soft)
S1_LOW_MIN   = 1.10;   S1_LOW_MAX  = 1.40   # 52W low range
S1_H60       = 0.90    # close >= 60D_high × 0.90
