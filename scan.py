...
# Sanitize NaN/Inf values — Python json.dumps writes NaN as literal NaN
# which is invalid JSON and breaks JavaScript JSON.parse()
def _san(o):
    import math as _m
    ...
    return o
content=json.dumps(_san(payload))
