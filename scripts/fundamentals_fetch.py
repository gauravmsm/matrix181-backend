...
import json, os, base64, time, requests, math
...
def sanitize_json(obj):
    ...
    Python json.dumps allows NaN by default but JSON spec forbids it.
    JavaScript JSON.parse() will throw on literal NaN.
    """
...
def safe_json_dumps(obj, **kwargs):
    """
    JSON serialize with NaN/Inf protection.
    sanitize_json converts NaN→None first,
    allow_nan=False raises ValueError if any slip through.
    """
...
def fetch_one(sym):
    ...
    return sym, {
        ...
        "epsGrowth3yr":   eps_g,  # alias — same field, structural scorer reads this
        "salesGrowth3yr": rev_g,  # alias — same field
    ...
    with ThreadPoolExecutor(max_workers=5) as ex:
        ...
        for fut in as_completed(futures):
            ...
            if done % batch_size == 0:
                ...
                out_str = safe_json_dumps(fund_data, indent=2)
